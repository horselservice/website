...
export default function SoundfieldProducts({ products }) {
    ...
    return (
        <>
            <Head>
        <title>Ljudutjämningssystem | Röstförstärkning för skola och möten</title>
        <meta name="description" content="Ljudutjämningssystem och röstförstärkning för klassrum, konferensrum och offentliga lokaler där tydligt tal och bättre ljudmiljö behövs." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://horselservice.se/ljudutjamningssystem" />
        <meta property="og:locale" content="sv_SE" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Ljudutjämningssystem | Röstförstärkning för skola och möten" />
        <meta property="og:description" content="Ljudutjämningssystem och röstförstärkning för klassrum, konferensrum och offentliga lokaler där tydligt tal och bättre ljudmiljö behövs." />
        <meta property="og:url" content="https://horselservice.se/ljudutjamningssystem" />
        <meta property="og:image" content="https://horselservice.se/images/rogerSoundfield2.webp" />
