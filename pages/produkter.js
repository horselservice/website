  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Utforska Hörselservice produktkategorier: passiva hörselskydd, aktiva hörselskydd och ljudutjämningssystem."
        />
        ...
        <meta
          property="og:title"
          content="Produkter | Hörselskydd och ljudutjämningssystem"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://horselservice.se/images/musik.webp"
        />
