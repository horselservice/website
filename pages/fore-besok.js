  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Information inför besök hos Hörselservice: så görs en avgjutning för formgjutna hörselskydd och detta bör du tänka på innan besöket."
        />
        ...
        <meta
          property="og:title"
          content="Så går en avgjutning till | Hörselservice Växjö"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://horselservice.se/images/formgjutningOra.webp"
        />
